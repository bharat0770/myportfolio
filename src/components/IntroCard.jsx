    ...
    return (
        <div className='w-full flex flex-col justify-center items-center gap-4 lg:gap-8 '>
            ...
            <p className='break-all '>
                Dedicated Full Stack Developer with extensive experience in building dynamic web applications. Proficient in utilizing modern frameworks and libraries to deliver scalable and innovative solutions.
            </p>

            <div className="flex gap-5 justify-center w-full px-10">
                {contactIcons.map((i, idx) => {
                    return <a className='relative  text-blue-900 hover:scale-125 transition-all duration-200 group text-2xl lg:text-4xl' href={i.link}> {i.icon}
