...
function TimeLineCard() {
    ...
    return (
        ...
        items-center text-xl'>
            <h1 className='text-center text-3xl lg:text-4xl text-gray-600'>My Learning <span className='text-blue-500'>Journey</span></h1>

            {
                TimeLine.map((i, idx) => (
                    idx % 2 == 0 ?
                        <div className='w-full flex justify-between' key={idx}>
                            <div className='w-[50%]  flex flex-col justify-center items-center text-gray-400 font-bold'>
                                {i.time}
                            </div>
                            ...
                            <div className='relative timeLineCard w-[50%] px-[0] lg:px-[8rem]  z-20 rounded-sm min-h-[10rem] bg-white shadow-lg flex flex-col justify-center items-center opacity-0 -translate-x-24 transition-all duration-700 ease-out group'>
                                {i.content}
                        ...
                        <div key={idx} className='w-full flex justify-between'>
                            ...
                            <div className='relative timeLineCard w-[50%] rounded-sm min-h-[10rem] px-10 bg-white shadow-lg flex flex-col justify-center items-center opacity-0 -translate-x-24 group transition-all duration-700 ease-out '>
                                {i.content}
